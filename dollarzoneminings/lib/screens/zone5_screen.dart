...
class Zone5Screen extends StatefulWidget {
  const Zone5Screen({super.key});

  @override
  State<Zone5Screen> createState() => _Zone5ScreenState();
}

class _Zone5ScreenState extends State<Zone5Screen> {
  ...
  // 🔸 10 distinct fake ad unit ids — replace later with your real AdMob IDs
  final List<String> fakeAdUnitIds = [
    'ca-app-pub-fake-5001/rewarded_ad_unit_01',
    'ca-app-pub-fake-5002/rewarded_ad_unit_02',
    'ca-app-pub-fake-5003/rewarded_ad_unit_03',
    'ca-app-pub-fake-5004/rewarded_ad_unit_04',
    'ca-app-pub-fake-5005/rewarded_ad_unit_05',
    'ca-app-pub-fake-5006/rewarded_ad_unit_06',
    'ca-app-pub-fake-5007/rewarded_ad_unit_07',
    'ca-app-pub-fake-5008/rewarded_ad_unit_08',
    'ca-app-pub-fake-5009/rewarded_ad_unit_09',
    'ca-app-pub-fake-5010/rewarded_ad_unit_10',
  ];
  ...
  Future<void> _loadZoneTotals() async {
    ...
    final z = (snap.data() ?? {})['zone5'] as Map<String, dynamic>?;
    if (z != null) {
      setState(() {
  ...
  Future<void> _moveCoinsToWalletAndResetZone() async {
    ...
    final zoneData = (doc.data() ?? {})['zone5'] as Map<String, dynamic>? ?? {};
    ...
    await _fire.runTransaction((tx) async {
      ...
      if (!walletSnap.exists) {
        tx.set(walletRef, {
          'balance': zoneCoins / 100, // 100 coins = $1
          'earnings': zoneCoins,
      ...
      tx.update(docRef, {
        'zone5.coinsEarned': 0,
        'zone5.buttonsCompleted': 0,
        'zone5.cyclesDoneToday': 0,
        'zone5.buttons': {},
      });
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Zone 5 Mining"),
      ),
      body: Padding(
        ...
        child: Column(
          children: [
            Text(
              "Zone 5 - Total Coins: ${totalCoins.toStringAsFixed(2)}",
