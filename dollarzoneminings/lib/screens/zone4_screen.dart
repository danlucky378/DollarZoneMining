...
class Zone4Screen extends StatefulWidget {
  const Zone4Screen({super.key});

  @override
  State<Zone4Screen> createState() => _Zone4ScreenState();
}

class _Zone4ScreenState extends State<Zone4Screen> {
  ...
  final List<String> fakeAdUnitIds = [
    'ca-app-pub-fake-4001/rewarded_ad_unit_01',
    'ca-app-pub-fake-4002/rewarded_ad_unit_02',
    'ca-app-pub-fake-4003/rewarded_ad_unit_03',
    'ca-app-pub-fake-4004/rewarded_ad_unit_04',
    'ca-app-pub-fake-4005/rewarded_ad_unit_05',
    'ca-app-pub-fake-4006/rewarded_ad_unit_06',
    'ca-app-pub-fake-4007/rewarded_ad_unit_07',
    'ca-app-pub-fake-4008/rewarded_ad_unit_08',
    'ca-app-pub-fake-4009/rewarded_ad_unit_09',
    'ca-app-pub-fake-4010/rewarded_ad_unit_10',
  ];
  ...
  Future<void> _loadZoneTotals() async {
    ...
    final z = (snap.data() ?? {})['zone4'] as Map<String, dynamic>?;
    if (z != null) {
      setState(() {
  ...
  Future<void> _moveCoinsToWalletAndResetZone() async {
    ...
    final zoneData = (doc.data() ?? {})['zone4'] as Map<String, dynamic>? ?? {};
    ...
    await _fire.runTransaction((tx) async {
      ...
      tx.update(docRef, {
        'zone4.coinsEarned': 0,
        'zone4.buttonsCompleted': 0,
        'zone4.cyclesDoneToday': 0,
        'zone4.buttons': {},
      });
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Zone 4 Mining"),
      ),
      body: Padding(
        ...
        child: Column(
          children: [
            Text(
              "Zone 4 - Total Coins: ${totalCoins.toStringAsFixed(2)}",
